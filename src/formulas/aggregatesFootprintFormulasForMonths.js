...
// Generic formulas
import { getLastDateOfMonth, getNbDaysBetweenDates, getNextMonth } from '../utils/Utils';
...
export const updateAccountsFootprints_month = async (indic,financialData,month) =>
{
    // External expenses --------------------------------------------------------- //

    await updateExternalExpensesAccountsFootprints_month(indic,financialData,month);

    // Purchase stocks ----------------------------------------------------------- //
    
    await updatePurchasesStocksAccountsFootprints_month(indic,financialData,month);
    await updatePurchasesStocksVariationsAccountsFootprints_month(indic,financialData,month);
    ...
    await updateAmortisationExpensesAccountsFootprints_month(indic,financialData,month);
...
export const updateExternalExpensesAccountsFootprints_month = async (indic,financialData,month) =>
{
