              ...
              <Col lg={{ span: 6, order: 1 }} sm={{ span: 12, order: 2 }}>
                <div className="ps-5">
                  ...
                  <p>
                    ...
                    d'activité et, si vous le souhaitez,{" "}
                    <b>valoriser votre empreinte</b> en la publiant au sein de
                    notre base de données ouverte.
                  </p>
                  <div className="mt-5">
                    <Button
                      variant="secondary"
            ...
            <Row>
              <Col>
                <div className="text-center border p-4  illu-box ">
                  ...
                  <p>
                    Le code source est ouvert, vous pouvez y accéder via notre
                    répertoire GitHub
                  </p>
                </div>
              </Col>
