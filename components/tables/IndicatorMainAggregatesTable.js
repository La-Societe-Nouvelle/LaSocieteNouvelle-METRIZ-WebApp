...
export const IndicatorMainAggregatesTable = ({ indic, session }) => {
  ...
  return (
    <> 
  <div className="piechart-container hidden">
       <PieGraph 
       intermediateConsumption={printValue(intermediateConsumption.footprint.indicators[indic].getGrossImpact(intermediateConsumption.amount), nbDecimals)} 
       capitalConsumption={printValue(intermediateConsumption.footprint.indicators[indic].getGrossImpact(intermediateConsumption.amount), nbDecimals)}
       netValueAdded={printValue(netValueAdded.footprint.indicators[indic].getGrossImpact(netValueAdded.amount), nbDecimals)}
       />
      ...
      <Table id="mainAggregates"> 
        ...
        <tbody>
          <tr>
            ...
            <td className="column_value">{printValue(production.amount, 0)} &euro;</td>
            <td className="column_value">{printValue(production.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          <tr>
            ...
            <td className="column_value">{printValue(revenue.amount, 0)} &euro;</td>
            <td className="column_value">{printValue(revenue.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          {storedProduction != 0 &&
            <tr>
              ...
              <td className="column_value">{printValue(storedProduction.amount, 0)} &euro;</td>
              <td className="column_value">{printValue(storedProduction.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          {immobilisedProduction.amount > 0 &&
            <tr>
              ...
              <td className="column_value">({printValue(immobilisedProduction.amount, 0)}) &euro;</td>
              <td className="column_value">{printValue(immobilisedProduction.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          <tr className="with-top-line">
            ...
            <td className="column_value">{printValue(intermediateConsumption.amount, 0)} &euro;</td>
            <td className="column_value">{printValue(intermediateConsumption.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          {intermediateConsumptionsAggregates.filter(aggregate => aggregate.amount != 0)
            .map(({ accountLib, amount, footprint }, index) =>
              <tr key={index}>
                ...
                <td className="column_value">{printValue(footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          <tr className="with-top-line">
            ...
            <td className="column_value">{printValue(capitalConsumption.amount, 0)} &euro;</td>
            <td className="column_value">{printValue(capitalConsumption.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
          ...
          <td className="align-right">{printValue(netValueAdded.amount, 0)} &euro;</td>
          <td className="align-right">{printValue(netValueAdded.footprint.indicators[indic].getValue(), nbDecimals)} {unit}</td>
